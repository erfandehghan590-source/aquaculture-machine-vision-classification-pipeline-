...
RUN_LOG_PATH =  str(SCRIPT_DIR / f"resnet50_training_log_{DATA_SUBSET.lower()}.jsonl")

GRADCAM_OUTPUT_DIR =  str(SCRIPT_DIR / f"gradcam_RESNET50_{DATA_SUBSET.lower()}_infected_predictions")
MODEL_SAVE_PATH =  str(SCRIPT_DIR / f"resnet50_{DATA_SUBSET.lower()}_salmonscan.pth")
...
def main():
    ...
    plt.title(f"Confusion Matrix - {DATA_SUBSET} - ResNet50")
    plt.show()
