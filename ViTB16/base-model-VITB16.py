...
RUN_LOG_PATH =  str(SCRIPT_DIR / f"vit_training_log_{DATA_SUBSET.lower()}.jsonl")

GRADCAM_OUTPUT_DIR =  str(SCRIPT_DIR / f"gradcam_VIT_{DATA_SUBSET.lower()}_infected_predictions")
MODEL_SAVE_PATH =  str(SCRIPT_DIR / f"vit_b16_{DATA_SUBSET.lower()}_salmonscan.pth")
...
def main():
    ...
    plt.title(f"Confusion Matrix - {DATA_SUBSET} - ViT-B/16")
    plt.show()
