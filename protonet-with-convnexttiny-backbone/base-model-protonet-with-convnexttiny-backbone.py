...
# تصویر خام برای overlay داخل proto_specified_utils ساخته می‌شود.
...
# برای محاسبه prototypeهای ثابت از train set نباید shuffle فعال باشد.
...
# =====================================================================
# ساخت مدل ProtoNet با Backbone ConvNeXt-Tiny
# =====================================================================
class ProtoNet(nn.Module):
    def __init__(self, embedding_dim: int = 256):
        ...
        # ساختار classifier در ConvNeXt:
        # Sequential(LayerNorm2d, Flatten, Linear)
