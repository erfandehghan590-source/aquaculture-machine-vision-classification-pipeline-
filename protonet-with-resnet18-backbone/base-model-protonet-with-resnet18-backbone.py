...
# برای Grad-CAM هم باید همان transform اعتبارسنجی استفاده شود،
# چون ورودی مدل باید مثل زمان train/eval نرمال‌سازی شود.
...
# برای ساخت prototype ثابت از train set نباید shuffle فعال باشد.
...
# =====================================================================
# ساخت مدل ProtoNet با Backbone ResNet18
# =====================================================================
